...
return [
    ...
    */
    'homepage' => 'Home',
    'clickme' => 'Click Me!',
    'javavc' => 'Java Versus C',
    'text1' => 'Here are some of the differences between Java and C language.',
    'tablebody' => '<tbody>
                            <tr>
                            ...
                            <tr>
                                <td>C is a middle-level language because binding of the gaps takes place between machine
                                    level language and high-level languages.</td>
                                <td>Java is a high-level language because translation of code takes place into machine
                                    language using compiler or interpreter.</td>
                            </tr>
                            <tr>
                                <td>C is a compiled language that is it converts the code into machine language so that
                                    it could be understood by the machine or system.</td>
                                <td>Java is an Interpreted language that is in Java, the code is first transformed into
                                    bytecode and that bytecode is then executed by the JVM (Java Virtual Machine).</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>C programming language can be used for system programming as well as Application
                                    programming.</td>
                                <td>This is not the case in Java.</td>
                            </tr>
                            <tr>
                                <td>C does not contain the property called Inheritance because it does not support OOPS,
                                    which is very useful for code reusability. Thus C is not suited when one has to
                                    relate the things according to the real world.</td>
                                <td>Java contains the property of Inheritance which is very useful in code reuseability.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td> C is a low-level language. It has difficult interpretation for the user but it has
                                    a closer significance to the machine-level code.</td>
                                <td>Java is a high-level language because translation of code takes place into machine
                                    language using compiler or interpreter.</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>C is not robust that is strict type checking does not takes place while compile and
                                    run time.</td>
                                <td>Java is robust.</td>
                            </tr>
                            <tr>
                                <td>Exception handling cannot be directly achieved in C and thus it lacks the
                                    maintenance of normal flow of the program.</td>
